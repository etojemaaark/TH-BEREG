...
$(window).scroll(function() {
    const bottomMain = $('.main').height() + $('.main').scrollTop();
...
$(".menu__item a").click(function(e){
    ...
    if($(window).width() < 768) {
        ...
        $('.mobile-menu').removeClass('mobile-menu_opened');
        $('.mobile-menu__inner').removeClass('mobile-menu__inner_opened');
        $("html, body").animate({scrollTop: $(_href).offset().top - 47 +"px"});
    } else {
        $("html, body").animate({scrollTop: $(_href).offset().top - 76 +"px"});
    }
...
function ajax(form) {
    ...
    .done(function() {
        ...
        if (form.attr('id') === 'form-callback') {
            yaCounter66156607.reachGoal('otpravka_zvonok'); gtag('event', 'zvonok', { 'event_category': 'otpravit_zvonok', 'event_action': 'click' }); gtag('event', 'page_view', { 'page_path': '/otpavka-zvonok-form' });
        }
        if (form.attr('id') === 'form-price') {
            yaCounter66156607.reachGoal('otpravka_stoimost'); gtag('event', 'zapros', { 'event_category': 'otpravit_stoimost', 'event_action': 'click' }); gtag('event', 'page_view', { 'page_path': '/otpavka-stoimost-form' });
        }
        if (form.attr('id') === 'form-consultation') {
            yaCounter66156607.reachGoal('otpravka_voprosy'); gtag('event', 'voprosy', { 'event_category': 'otpravform_voprosy', 'event_action': 'click' }); gtag('event', 'page_view', { 'page_path': '/otpavka-voprosy-form' });
        }
